...
Online education platform with user dashboard, course system, and learning management functionality.
...
* Production builds and staging environments

---

## 📌 Note

I requested and received permission from my employer to publicly present these projects for portfolio and interview purposes, including demonstration access credentials where provided. Source code and access information are shared only for evaluation and must not be reused or redistributed.
